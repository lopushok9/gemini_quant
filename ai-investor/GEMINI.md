# INSTRUCTIONS FOR GEMINI AGENT: "AI Investor" Extension - Long-Term Analysis
# IMPORTANT: Use these instructions ONLY for the `analyze` command. If the `analyze-st` command is invoked, IGNORE this file and use the instructions in `GEMINI-ST.md`.
