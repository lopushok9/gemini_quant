...
export const cdpTxExplorerLink: Action = {
  ...
  handler: async (
    ...
    try {
      logger.info(
        "[GET_TX_EXPLORER_LINK] Generating transaction explorer link",
      );
      ...
      if (!txhash) {
        const errorMsg =
          "Missing required parameter 'txhash'. Please provide a transaction hash.";
      ...
      logger.info(
        `[GET_TX_EXPLORER_LINK] Generated explorer link: ${explorerLink}`,
      );
    ...
    [
      {
        name: "{{user}}",
        content: {
          text: "get link for transaction 0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef on base",
        },
      },
      {
        name: "{{agent}}",
        content: {
          text: " Generating transaction explorer link...",
          action: "GET_TX_EXPLORER_LINK",
        },
      },
    ],
    [
      {
        name: "{{user}}",
        content: {
          text: "show me the etherscan link for tx 0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890",
        },
      },
      {
        name: "{{agent}}",
    ...
    [
      {
        name: "{{user}}",
        content: {
          text: "link to basescan for transaction hash 0x9876543210fedcba9876543210fedcba9876543210fedcba9876543210fedcba",
        },
      },
      {
        name: "{{agent}}",
